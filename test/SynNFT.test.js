...
describe("ERC721Manageable", function () {

  let ERC721Manageable
  let everDragons2
  let DragonsMaster
  let dragonsMaster
  ...
  beforeEach(async function () {
    ERC721Manageable = await ethers.getContractFactory("ERC721Manageable")
    everDragons2 = await ERC721Manageable.deploy()
  ...
  it("should return the ERC721Manageable name and symbol", async function () {
    expect(await everDragons2.name()).to.equal("ERC721Manageable")
